import "../mobile/pages/Tab1-Home.css";
    ...
    <IonPage>
      ...
      <IonContent fullscreen scrollEvents={true}>
          ...
          <IonToolbar>
            <div className="header ion-padding">
              <span>
                ...
                <Skeleton loading variant="shine" width="20ch">
                  <h3 className="subtitle">{"NoName"}</h3>
                </Skeleton>
              </span>
        ...
        <div className="ion-padding">
          ...
          <br />
          <div>
            <Skeleton loading variant="shine" width="30ch">
              <h3 className="subtitle">{"NoName"}</h3>
            </Skeleton>
          </div>
        </div>
        <div className="home-content-section ion-padding">
          ...
          <br />
          <br />
          <SkeletonText noOfLines={3} variant="shine" />
          <br />
          <br />
          <br />
          <Skeleton height="200px" width="100%" variant="shine" />
        </div>
      </IonContent>
    </IonPage>
  );
